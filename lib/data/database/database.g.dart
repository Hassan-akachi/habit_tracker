...
class $HabitsTable extends Habits with TableInfo<$HabitsTable, Habit> {
  ...
  static const VerificationMeta _totlaCompletionsMeta =
      const VerificationMeta('totlaCompletions');
  @override
  late final GeneratedColumn<int> totlaCompletions = GeneratedColumn<int>(
      'totla_completions', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
      defaultValue: Constant(0));
  ...
  VerificationContext validateIntegrity(Insertable<Habit> instance,
    ...
    if (data.containsKey('totla_completions')) {
      context.handle(
          _totlaCompletionsMeta,
          totlaCompletions.isAcceptableOrUnknown(
              data['totla_completions']!, _totlaCompletionsMeta));
    }
  ...
  Habit map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Habit(
      ...
      totlaCompletions: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}totla_completions'])!,
...
class Habit extends DataClass implements Insertable<Habit> {
  ...
  const Habit(
      ...
      required this.totlaCompletions,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['totla_completions'] = Variable<int>(totlaCompletions);
  ...
  HabitsCompanion toCompanion(bool nullToAbsent) {
    return HabitsCompanion(
      ...
      reminderTime: reminderTime == null && nullToAbsent
          ...
          : Value(reminderTime),
      streak: Value(streak),
      totlaCompletions: Value(totlaCompletions),
  ...
  factory Habit.fromJson(Map<String, dynamic> json,
    ...
    return Habit(
      ...
      totlaCompletions: serializer.fromJson<int>(json['totlaCompletions']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'totlaCompletions': serializer.toJson<int>(totlaCompletions),
  ...
  Habit copyWith(
      ...
      Habit(
        ...
        totlaCompletions: totlaCompletions ?? this.totlaCompletions,
  ...
  Habit copyWithCompanion(HabitsCompanion data) {
    return Habit(
      ...
      totlaCompletions: data.totlaCompletions.present
          ? data.totlaCompletions.value
          : this.totlaCompletions,
  ...
  String toString() {
    return (StringBuffer('Habit(')
          ...
          ..write('streak: $streak, ')
          ..write('totlaCompletions: $totlaCompletions, ')
  ...
  int get hashCode => Object.hash(id, title, description, createdAt,
      reminderTime, streak, totlaCompletions, isDaily);
  @override
  bool operator ==(Object other) =>
      ...
      (other is Habit &&
          ...
          other.totlaCompletions == this.totlaCompletions &&
...
class HabitsCompanion extends UpdateCompanion<Habit> {
  ...
  final Value<int> totlaCompletions;
  ...
  const HabitsCompanion({
    ...
    this.totlaCompletions = const Value.absent(),
  ...
  static Insertable<Habit> custom({
    ...
    Expression<int>? totlaCompletions,
    ...
    return RawValuesInsertable({
      ...
      if (totlaCompletions != null) 'totla_completions': totlaCompletions,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (totlaCompletions.present) {
      map['totla_completions'] = Variable<int>(totlaCompletions.value);
    }
    if (isDaily.present) {
...
class $$HabitsTableFilterComposer
  ...
  ColumnFilters<int> get totlaCompletions => $composableBuilder(
      column: $table.totlaCompletions,
...
class $$HabitsTableOrderingComposer
  ...
  ColumnOrderings<int> get totlaCompletions => $composableBuilder(
      column: $table.totlaCompletions,
      builder: (column) => ColumnOrderings(column));
...
class $$HabitsTableAnnotationComposer
  ...
  GeneratedColumn<int> get totlaCompletions => $composableBuilder(
      column: $table.totlaCompletions, builder: (column) => column);
  ...
  $$HabitsTableTableManager(_$AppDatabase db, $HabitsTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<int> totlaCompletions = const Value.absent(),
            ...
            streak: streak,
            totlaCompletions: totlaCompletions,
            isDaily: isDaily,
          ),
